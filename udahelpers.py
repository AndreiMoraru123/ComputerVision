...
# For example, after faces_data is loaded, im_list[0][:] will be the first image-label pair in the list
...
def standardize(image_list):
    ...
    for item in image_list:
        ...
        # Append the image, and it's one hot encoded label to the full, processed list of image faces_data

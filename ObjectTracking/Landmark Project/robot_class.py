...
class robot:
    ...
    def __init__(self, world_size=100.0, measurement_range=30.0,
                 motion_noise=1.0, measurement_noise=1.0, yaw=0):
    ...
    def sense(self):
        ...
        for i in range(self.num_landmarks):
            ...
            orientation = atan2(dy, dx) - self.yaw
            if abs(line_of_sight * cos(orientation)) <= self.measurement_range and abs(
                    line_of_sight * sin(orientation)) <= self.measurement_range:
